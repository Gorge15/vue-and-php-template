<template>
<div>
    <div class="error" v-if="access === false"><p>Contul exista deja!</p></div>
    <div class="login-base">
      <h1 class="noselect">Register</h1>
      <form action="" method="post">
        <input type="text" placeholder="username" minlength="4" maxlength="32" v-model="username">
        <input type="password" placeholder="password" minlength="4" maxlength="32" v-model="password">
        
        
      </form>
      <button class="log-in-btn" @click="register">Register</button>
    </div>
  </div>
</template>
